...
CREATE TABLE if NOT EXISTS kung_media_category(
  ...
  source_type tinyint(1) unsigned NOT NULL default 0 comment'资源类型 1：视频， 2，音频 3：pdf资料',
...
CREATE TABLE if NOT EXISTS kung_media(
  ...
  source_type int unsigned NOT NULL DEFAULT 0 comment'资源类型 1：视频 2：音频 3: pdf资料',
  ...
  media_desc varchar(4096) NOT NULL default '' comment'描述',
  ...
  real_download_num int unsigned NOT NULL DEFAULT 0 comment'真实下载量',
  sort_order int unsigned NOT NULL DEFAULT 500 comment'排序字段',
  create_time bigint unsigned  NOT NULL DEFAULT 0 comment'创建时间',
  update_time bigint unsigned  NOT NULL DEFAULT 0 comment'修改时间',
  status tinyint unsigned NOT NULL DEFAULT 0 comment'状态 0：有效 1：删除',
