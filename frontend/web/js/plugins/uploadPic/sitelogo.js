window.onload = function () {
    (function (factory) {
        ...
        function CropAvatar($element) {
            ...
            this.$avatarView = this.$container.parent('.s-c-pic').find('.s-c-pic-in');
            ...
            this.$albumPic = this.$avatarModal.find('.album-pic');
            this.$avatarPreview = this.$avatarModal.find('.avatar-preview');
            this.init();
            console.log(this.$avatar.attr('src'))
        }
        ...
        CropAvatar.prototype = {
            ...
            initPreview: function () {
                ...
                console.log(url)
                this.$albumPic.empty().html('<img src="' + url + '">');
            },
            initIframe: function () {
            ...
            startCropper: function () {
                ...
                if (this.active) {
                    ...
                    this.$img.cropper({
                        aspectRatio: 16 / 9,
                        preview: this.$albumPic.selector,
                        strict: false,
                        crop: function (data) {
        ...
        $(function () {
            return new CropAvatar($('[name="uploadPagePic"]'));
        });
    })
};
