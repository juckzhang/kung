    ...
    <form method="post" action="<?=Url::to(['media/edit-lines','id' => ArrayHelper::getValue($model,'id','')])?>" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone)">
        <div class="pageFormContent nowrap" layoutH="97">
            ...
            <dl>
                <dt>开始时间：</dt>
                <dd>
                    <input type="text" name="MediaLinesModel[start_time]" maxlength="20" class="required" value="<?=ArrayHelper::getValue($model,'start_time','')?>"/>
            ...
            <dl>
                <dt>结束时间：</dt>
                <dd>
                    <input type="text" name="MediaLinesModel[end_time]" maxlength="20" class="required" value="<?=ArrayHelper::getValue($model,'end_time','')?>"/>
