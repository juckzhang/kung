...
<div class="" id="card-list" rel="card-list">
    ...
    <div class="pageHeader">
        <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?=Url::to(['article/feedback-list'])?>" method="post">
            <div class="searchBar">
                <table class="searchContent">
                    <tbody>
                    <tr>
                        <td>反馈内容：<input name="keyword" class="textInput" type="text" alt="反馈内容"></td>
                    </tr>
                    </tbody>
                </table>
                <div class="subBar">
    ...
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
                ...
                <?php if(\Yii::$app->user->can('article/delete-feedback')):?>
                    <li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids[]" href="<?=Url::to(['article/delete-feedback'])?>" class="delete"><span>批量删除</span></a></li>
                <?php endif;?>
        ...
        <table class="table" width="1200" layoutH="138">
            ...
            <?php foreach($dataList as $key => $data):?>
                <tr target="card-id" rel="<?=$data->id?>">
                    ...
                    <td>
                        <?php if(\Yii::$app->user->can('article/delete-feedback')):?>
                            <a title="删除" target="ajaxTodo" href="<?=Url::to(['article/delete-feedback','ids' => $data->id])?>" class="btnDel">删除</a>
                        <?php endif;?>
                    </td>
                </tr>
            <?php endforeach;?>
