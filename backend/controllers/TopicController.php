...
use common\models\mysql\TopicModel;
use Yii;
...
class TopicController extends BaseController
{
    ...
    public function actionEditTopic()
    {
        ...
        {
            $result = AdService::getService()->editTopic($id);
            ...
            //获取广告id
//            $model = TopicModel::find()->where(['id' => $id])->asArray()->one();

            return $this->render('edit-topic',['model' => []]);
        }
    }
